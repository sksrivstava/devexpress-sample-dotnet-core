...
declare module DevExpress {
    module Analytics {
        module Data {
            ...
            class JsonSchemaRootNode extends JsonNode {
                ...
                getInfo(): DXImport.Analytics.Utils.ISerializationInfoArray;
                constructor(model: any, serializer?: DXImport.Analytics.Utils.IModelSerializer);
                getRootElementPartList(allowObjectRootElements?: boolean): DXImport.Analytics.Utils.IPathRequest[];
            ...
            class JsonParameter extends DXImport.Analytics.Utils.Disposable {
                ...
                static from(model: any, serializer?: DXImport.Analytics.Utils.IModelSerializer): JsonParameter;
                ...
                _expression: DXImport.Analytics.Widgets.IExpressionOptions;
                isExpression: ko.Observable<boolean>;
                itemsProvider: DXImport.Analytics.Utils.IItemsProvider;
                _parameterTypes: {
                    value: string;
                    displayValue: string;
            ...
            module Metadata {
                ...
                function storedProcParameterSerializationsInfo(type: string): DXImport.Analytics.Utils.ISerializationInfo[];
            }
        ...
        module Wizard {
            ...
            class ConfigureObjectDataSourceParametersPage extends WizardPageBase<IObjectDataSourceWizardState, IObjectDataSourceWizardState> {
                ...
                constructor(itemsProvider: DXImport.Analytics.Utils.IItemsProvider);
                canNext(): boolean;
                canFinish(): boolean;
            ...
            function _registerConfigureObjectDataSourceParametersPage(factory: PageFactory, getItemsProviderCallback: () => DXImport.Analytics.Utils.IItemsProvider): void;
            ...
            class SpecifyJsonConnectionPage extends ChooseJsonConnectionPage {
                private _requestWrapper;
                constructor(connections: any, allowCreateNewJsonConnection: any, itemsProvider?: DXImport.Analytics.Utils.IItemsProvider, _requestWrapper?: QueryBuilder.Utils.RequestWrapper);
                commit(): JQuery.Promise<IJsonDataSourceWizardState, any, any>;
                canNext(): boolean;
                initialize(state: any): JQuery.Promise<IWizardPage, any, any>;
                _specifySourceData: ChooseJsonSourcePage;
            }
            function _registerSpecifyJsonConnectionPage(factory: PageFactory, connections: ko.ObservableArray<any>, allowCreateNewJsonConnection: boolean, getItemsProviderCallBack: () => DXImport.Analytics.Utils.IItemsProvider): void;
            class ChooseJsonSourcePage extends WizardPageBase<IJsonDataSourceWizardState, IJsonDataSourceWizardState> {
                ...
                constructor(_requestWrapper?: QueryBuilder.Utils.RequestWrapper, itemsProvider?: DXImport.Analytics.Utils.IItemsProvider);
                canNext(): boolean;
                commit(): JQuery.Promise<IJsonDataSourceWizardState, any, any>;
            ...
            function _registerChooseJsonSourcePage(factory: PageFactory, requestWrapper?: QueryBuilder.Utils.RequestWrapper, getItemsProviderCallback?: any): void;
            class ChooseJsonSchemaPage extends WizardPageBase<IJsonDataSourceWizardState, IJsonDataSourceWizardState> {
                ...
                protected _filterRootElementList(rootElementList: DXImport.Analytics.Utils.IPathRequest[], jsonSchema: Analytics.Data.JsonSchemaRootNode): DXImport.Analytics.Utils.IPathRequest[];
                canNext(): boolean;
                canFinish(): boolean;
            ...
            class PopupWizard extends BaseWizard {
                ...
                itemsProvider: ko.Observable<DXImport.Analytics.Utils.IItemsProvider>;
                nextButton: {
                    text: any;
            ...
            module Legacy {
                ...
                class JsonDataSourceJsonSourcePage<T extends IDataSourceWizardModel> extends WizardPage<T> {
                    ...
                    private _jsonStringSettings;
                    private _jsonUriSetting;
                    constructor(wizard: WizardViewModel<T>, itemsProvider: any);
                    _begin(data: T): void;
                    reset(): void;
                    commit(data: T): void;
            ...
            module Internal {
                ...
                class JsonDataSourceJsonSourcePageUriSettings extends JsonDataSourceJsonSourcePageSettingsBase implements IJsonDataSourceJsonSourcePageSettings {
                    ...
                    constructor(_requestWrapper: QueryBuilder.Utils.RequestWrapper, _itemsProvider?: DXImport.Analytics.Utils.IItemsProvider);
                    protected _onValidationSummaryInitialized(args: any): void;
            ...
            module Internal {
                ...
                interface IDataSourceWizardCallbacks extends IJsonDataSourceWizardCallbacks {
                    ...
                    getItemsProviderCallback?: () => DXImport.Analytics.Utils.IItemsProvider;
                }
                class CustomQueryTreeListItem extends DXImport.Analytics.Widgets.Internal.TreeListItemViewModel {
                    dispose(): void;
                ...
                class MultiQueryTreeListItemFactory extends DXImport.Analytics.Widgets.Internal.DefaultTreeListItemFactory {
                    createItem(options: any, path?: string[], onItemsVisibilityChanged?: any, rtl?: any, resolver?: any): DXImport.Analytics.Widgets.Internal.TreeListItemViewModel | CustomQueryTreeListItem;
                }
                ...
                class ParametersTreeListItemBase extends DXImport.Analytics.Utils.Disposable implements DXImport.Analytics.Utils.IDataMemberInfo {
                ...
                class ParametersTreeListRootItemBase implements DXImport.Analytics.Utils.IDataMemberInfo {
                ...
                class SelectStatementQueryControl extends DXImport.Analytics.Utils.Disposable implements ISqlQueryControl {
    ...
    module Analytics {
        module Wizard {
            module Internal {
                ...
                interface IObjectSchemaProvider extends DXImport.Analytics.Utils.IItemsProvider {
                ...
                class ObjectSchemaProvider extends DXImport.Analytics.Utils.Disposable implements IObjectSchemaProvider {
                    private _requestWrapper;
                    private _objectTypeDescriptionsPromise;
                    constructor(_requestWrapper?: QueryBuilder.Utils.RequestWrapper);
                    dispose(): void;
                    getItems: (IPathRequest: any) => JQueryPromise<DXImport.Analytics.Utils.IDataMemberInfo[]>;
                    getSchemaByPath(pathRequest: DXImport.Analytics.Utils.IPathRequest, objectSchema: ObjectTypeDescriptions): DXImport.Analytics.Utils.IDataMemberInfo[];
                    getObjectTypeDescriptions(context?: string): JQueryPromise<ObjectTypeDescriptions>;
                }
                class ChooseObjectTypesTreelistController extends DXImport.Analytics.Widgets.Internal.TreeListController {
                    canSelect(value: any): boolean;
                }
                class ChooseObjectTypes extends DXImport.Analytics.Utils.Disposable {
                    ...
                    availableTypesTreelistModel: DXImport.Analytics.Widgets.Internal.ITreeListOptions;
                    selectedType: ko.Observable<Data.ObjectType>;
                    selectedCtor: ko.Observable<Data.ObjectCtor>;
                    selectedPath: ko.Observable<string>;
                    _scrollViewHeight: string;
                }
                class ObjectDataSourceParameterProperty extends DXImport.Analytics.Utils.Disposable {
                    private _parameter;
                    private _itemsProvider;
                    ...
                    constructor(_parameter: Data.ObjectParameter, _itemsProvider: DXImport.Analytics.Utils.IItemsProvider);
                    actions: DXImport.Analytics.Internal.IModelAction[];
                    actionProviders: DXImport.Analytics.Internal.IModelActionProvider[];
                    reset: () => void;
                    getInfo: () => DXImport.Analytics.Utils.ISerializationInfoArray;
                    type: ko.Observable<string>;
                    value: ko.Observable<string>;
                    expression: DXImport.Analytics.Widgets.IExpressionOptions;
                }
                class ObjectDataSourceParameterGrid extends DXImport.Analytics.Widgets.ObjectProperties {
                    constructor(x: ObjectDataSourceParameterProperty);
                }
                class ObjectDataSourceParametersModel extends DXImport.Analytics.Utils.Disposable {
                    _grids: ObjectDataSourceParameterGrid[];
                    displayName: string;
                    constructor(parametersMethod: Data.ObjectDataSourceMethodBase, itemsProvider: DXImport.Analytics.Utils.IItemsProvider);
                }
                class ChooseObjectMemberParameters extends DXImport.Analytics.Utils.Disposable {
                    private _itemsProvider;
                    private _ctorParametersObject;
                    private _dataMemberParametersObject;
                    private _updateParameters;
                    constructor(_itemsProvider: DXImport.Analytics.Utils.IItemsProvider);
                ...
                class ChooseObjectParameters extends ChooseObjectMemberParameters {
                    constructor(selectedCtor: ko.Observable<Data.ObjectCtor>, selectedDataMembers: ko.ObservableArray<Data.ObjectDataMember>, itemsProvider: DXImport.Analytics.Utils.IItemsProvider);
                }
                class ChooseObjectDataMembers extends DXImport.Analytics.Utils.Disposable {
        ...
        module Data {
            class ObjectDataSource extends DXImport.Analytics.Utils.Disposable implements IDataSourceBase {
            ...
            class ObjectDataMemberBase implements DXImport.Analytics.Utils.IDataMemberInfo {
                name: string;
                displayName: string;
                dataMember: string;
    ...
    module QueryBuilder {
        ...
        module Internal {
            ...
            }, callbacks?: DXImport.Analytics.Internal.ICommonCustomizationHandler, localization?: any, rtl?: boolean): JQuery.Deferred<any, any, any>;
            interface ITabModel {
                editableObject: any;
        ...
        module Internal {
            ...
            class QueryBuilderTreeListController extends DXImport.Analytics.Widgets.Internal.TreeListController {
                constructor(undoEngine: ko.Observable<DXImport.Analytics.Utils.UndoEngine>, query: ko.Observable<Elements.QueryViewModel>);
