...
var DevExpress = require('./dx-analytics-core');
var $ = require('jquery');
...
DevExpress.ui.dxScrollView = DevExpress.ui.dxScrollView || require('devextreme/ui/scroll_view');
DevExpress.validationEngine = require("devextreme/ui/validation_engine");
DevExpress.config = require('devextreme/core/config');
DevExpress.QueryBuilder = DevExpress.QueryBuilder || {};
DevExpress.Analytics = DevExpress.Analytics || {};
DevExpress.Analytics.Data = DevExpress.Analytics.Data || {};
DevExpress.Analytics.Wizard = DevExpress.Analytics.Wizard || {};

module.exports = {
    QueryBuilder: DevExpress.QueryBuilder,
    Analytics: {
        Data: DevExpress.Analytics.Data,
        Wizard: DevExpress.Analytics.Wizard,
        Diagram: DevExpress.Analytics.Diagram
    }
};
            ...
            ko.bindingHandlers["updateConnectorArrow"] = {
                init: function (svgNode, valueAccessor, allBindings, viewModel, bindingContext) {
                    ...
                    if (ieVersion > -1 && ieVersion <= 11) {
                        ...
                        Analytics.Internal.addDisposeCallback(svgNode.parentNode, function () { return updateSubscription.dispose(); });
                    }
                }
            };
...
(function (DevExpress) {
    ...
    (function (Analytics) {
        ...
        (function (Data) {
            ...
            })(JsonParameterType = Data.JsonParameterType || (Data.JsonParameterType = {}));
            var JsonParameter = (function (_super) {
                ...
                JsonParameter.prototype.getInfo = function () {
                    return [
                        { propertyName: "name", modelName: "@Name", displayName: "Name", editor: Analytics.Widgets.editorTemplates.text },
                        { propertyName: "value", modelName: "@Value", displayName: "Value", editor: Analytics.Widgets.editorTemplates.text },
            ...
            var JsonSource = (function (_super) {
                ...
                function JsonSource(model, serializer) {
                    ...
                    function _getJsonParametersModelDeserialized(parameterModels, itemType) {
                        ...
                        return Analytics.Utils.deserializeArray(parameterModels, function (item) {
                            if (!item["@ItemType"])
                                item["@ItemType"] = JsonParameterType[itemType];
                            return new JsonParameter(item, serializer);
                        });
                    }
                    _this.queryParameters = _getJsonParametersModelDeserialized(model["QueryParameters"], JsonParameterType.QueryParameter);
                    _this.headers = _getJsonParametersModelDeserialized(model["Headers"], JsonParameterType.Header);
                    _this.pathParameters = _getJsonParametersModelDeserialized(model["PathParameters"], JsonParameterType.PathParameter);
                    return _this;
                }
            ...
            (function (Internal) {
                function getJsonSchemaCallback(requestWrapper, jsonDataSource, parameters) {
                    if (parameters === void 0) { parameters = []; }
                    var deferred = $.Deferred();
            ...
            var JsonSchemaProvider = (function (_super) {
                ...
                JsonSchemaProvider.prototype.getJsonSchema = function (parameters) {
                    ...
                    if (!this._jsonSchemaPromise || this._jsonSchemaPromise.state() === "rejected")
                        this._jsonSchemaPromise = Internal.getJsonSchemaCallback(this._requestWrapper, this._jsonDataSource, parameters);
            ...
            var StoredProcQuery = (function () {
                function StoredProcQuery(model, parent, serializer) {
                    ...
                    this.parameters = Analytics.Utils.deserializeArray(model["Parameters"], function (item) {
                        ...
                        if (Analytics.Internal.IsDataAccessExpression(parameterValueType))
            ...
            (function (Metadata) {
                ...
                var dsParameterType = {
                    propertyName: "type", displayName: "Type", localizationId: "DevExpress.DataAccess.Parameter.Type", modelName: "@Type", editor: Analytics.Widgets.editorTemplates.combobox, valuesArray: [
                        ...
                        { value: Analytics.Internal.ExpressionType, displayValue: "Expression", localizationId: "DataAccessUIStringId.ParametersColumn_Expression" }
                    ]
                };
                var dsExpressionResultType = {
                    ...
                    valuesArray: dsParameterType.valuesArray.filter(function (x) { return !Analytics.Internal.IsDataAccessExpression(x.value); })
                };
                ...
                function storedProcParameterSerializationsInfo(type) {
                    ...
                    newValuesArray.push(dsParameterType.valuesArray.filter(function (item) { return Analytics.Internal.IsDataAccessExpression(item.value); })[0]);
            ...
            function integerValueConverter(val, defaultVal, type) {
                return Analytics.Internal.integerValueConverter(val, defaultVal, type);
            }
            function floatValueConverter(val, defaultVal, type) {
                return Analytics.Internal.floatValueConverter(val, defaultVal, type);
            }
            ...
            var DataSourceParameter = (function (_super) {
                ...
                function DataSourceParameter(model, serializer, _serializationsInfo) {
                    ...
                    _this._disposables.push(_this.type.subscribe(function (val) {
                        if (Analytics.Internal.IsDataAccessExpression(val)) {
                    ...
                    _this._previousResultType = (Analytics.Internal.IsDataAccessExpression(_this.type.peek()))
                        ? _this.resultType()
                        : _this.type();
                    _this.value = ko.pureComputed({
                        read: function () {
                            return Analytics.Internal.IsDataAccessExpression(_this.type()) ? _this._expressionValue() : _this._value();
                        },
                        write: function (val) {
                            _this._value(val);
                        }
                ...
                DataSourceParameter._getTypeValue = function (typeName, resultType) {
                    ...
                    if (result.length > 0) {
                        if (resultType && Analytics.Internal.IsDataAccessExpression(typeName))
                ...
                Object.defineProperty(DataSourceParameter.prototype, "specifics", {
                    get: function () {
                        var _this = this;
                        var result = DataSourceParameter._typeValues.filter(function (type) { return type.name === _this.type(); });
                        if (result.length > 0)
                ...
                DataSourceParameter.prototype.isPropertyVisible = function (propName) {
                    if (propName === "resultType")
                        return Analytics.Internal.IsDataAccessExpression(this.type());
                    return true;
                };
                DataSourceParameter._typeValues = [
                    ...
                    new DataSourceParameterTypeValue(Analytics.Internal.ExpressionType, "", expressionValueConverter),
        ...
        (function (Wizard) {
            ...
            Wizard.ObjectDataSourceWizardPageId = {
            ...
            function _restoreObjectDataSourceFromState(state, requestWrapper, dataSourceId) {
                var objectDataSource = new Data.ObjectDataSource();
                objectDataSource.setState(state);
                if (dataSourceId)
                    objectDataSource.id = dataSourceId;
                return objectDataSource;
            }
            Wizard._restoreObjectDataSourceFromState = _restoreObjectDataSourceFromState;
            function _createDefaultDataSourceWizardState(sqlDataSourceWizardState, jsonDataSourceWizardState, objectDataSourceWizardState) {
                ...
                if (objectDataSourceWizardState === void 0) { objectDataSourceWizardState = { dataSourceName: "ObjectDataSource" }; }
                return {
            ...
            function _registerChooseSqlConnectionPage(factory, connectionStrings) {
                factory.registerMetadata(Wizard.SqlDataSourceWizardPageId.ChooseConnectionPage, {
                    ...
                    description: Analytics.Internal.isCustomizedWithUpdateLocalizationMethod("Choose a data connection") || Analytics.Utils.getLocalization("Choose a data connection.", "AnalyticsCoreStringId.SqlDSWizard_PageChooseConnection")
                });
            }
            ...
            var ConfigureObjectDataSourceParametersPage = (function (_super) {
                ...
                function ConfigureObjectDataSourceParametersPage(itemsProvider) {
                    var _this = _super.call(this) || this;
                    _this._objectDataSource = new Data.ObjectDataSource();
                    _this._disposables.push(_this._chooseObjectParameters = new Internal.ChooseObjectMemberParameters(itemsProvider));
                    return _this;
                }
            ...
            Wizard.ConfigureObjectDataSourceParametersPage = ConfigureObjectDataSourceParametersPage;
            function _registerConfigureObjectDataSourceParametersPage(factory, getItemsProviderCallback) {
                factory.registerMetadata(Wizard.ObjectDataSourceWizardPageId.ConfigureParametersPage, {
                    setState: function (data, state) {
                    ...
                    description: Analytics.Utils.getLocalization("Configure constructor parameters and/or method parameters.", "AnalyticsCoreStringId.ObjectDSWizard_ConfigureParameters_Description"),
                    template: "dx-objectdatasource-configureparameters-page"
                });
            }
            Wizard._registerConfigureObjectDataSourceParametersPage = _registerConfigureObjectDataSourceParametersPage;
            var ChooseObjectDataSourceTypesPage = (function (_super) {
                ...
                function ChooseObjectDataSourceTypesPage(_requestWrapper) {
                    ...
                    _this._disposables.push(_this._provider = new Internal.ObjectSchemaProvider(_this._requestWrapper), _this._chooseObjectType = new Internal.ChooseObjectTypes(_this._types, _this._provider));
                    return _this;
                }
                ...
                ChooseObjectDataSourceTypesPage.prototype.initialize = function (state) {
                    ...
                    this._provider.getObjectTypeDescriptions(state.context).done(function (schema) {
                        schema.types.forEach(function (type) { return type.members.splice(0, 0, Data.ObjectDataMember.empty()); });
            ...
            Wizard.ChooseObjectDataSourceTypesPage = ChooseObjectDataSourceTypesPage;
            function _registerChooseObjectDataSourceTypesPage(factory, dataSourceWizardOptions) {
                factory.registerMetadata(Wizard.ObjectDataSourceWizardPageId.ChooseTypesPage, {
                    setState: function (data, state) {
                        state.selectedType = data.selectedType;
                    ...
                    description: Analytics.Utils.getLocalization("Choose the type and its constructor.", "AnalyticsCoreStringId.ObjectDSWizard_ChooseType_Description"),
                    template: "dxrd-page-objectdatasource-types"
                });
            }
            Wizard._registerChooseObjectDataSourceTypesPage = _registerChooseObjectDataSourceTypesPage;
            var ChooseObjectDataSourceDataMembersPage = (function (_super) {
                ...
                function ChooseObjectDataSourceDataMembersPage(_requestWrapper) {
                    ...
                    _this._disposables.push(_this._chooseObjectDataMember = new Internal.ChooseObjectDataMembers(_this._type, _this._ctor));
                    return _this;
                }
            ...
            Wizard.ChooseObjectDataSourceDataMembersPage = ChooseObjectDataSourceDataMembersPage;
            function _registerChooseObjectDataSourceDataMembersPage(factory, dataSourceWizardOptions) {
                factory.registerMetadata(Wizard.ObjectDataSourceWizardPageId.ChooseDataMembersPage, {
                    setState: function (data, state) {
                        state.selectedType = data.selectedType;
                        state.ctor = data.ctor;
                        state.dataMember = data.dataMember;
                    ...
                    description: Analytics.Utils.getLocalization("Choose the entire object or a data member to bind.", "AnalyticsCoreStringId.ObjectDSWizard_ChooseDataMember_Description"),
                    template: "dxrd-page-objectdatasource-datamembers"
                });
            }
            Wizard._registerChooseObjectDataSourceDataMembersPage = _registerChooseObjectDataSourceDataMembersPage;
            ...
            var SpecifyJsonConnectionPage = (function (_super) {
                ...
                function SpecifyJsonConnectionPage(connections, allowCreateNewJsonConnection, itemsProvider, _requestWrapper) {
                    ...
                    _this._requestWrapper = _requestWrapper;
                    _this._disposables.push(_this._specifySourceData = new ChooseJsonSourcePage(_requestWrapper, itemsProvider));
            ...
            var ChooseJsonSourcePage = (function (_super) {
                ...
                function ChooseJsonSourcePage(_requestWrapper, itemsProvider) {
                    ...
                    _this._disposables.push(_this._jsonUriSetting = new Analytics.Wizard.Internal.JsonDataSourceJsonSourcePageUriSettings(_this._requestWrapper, itemsProvider));
            ...
            var ConfigureQueryPage = (function (_super) {
                ...
                function ConfigureQueryPage(_options) {
                    ...
                    _this.queryNameCaption = function () { return DevExpress.Analytics.Utils.getLocalization("Query Name", "AnalyticsCoreStringId.SqlDSWizard_QueryName") + ":"; };
                    ...
                    _this.placeholder = function () {
                        ...
                        return queryName ? Analytics.Internal.formatUnicorn(Analytics.Utils.getLocalization("Type custom query name (current name: {0})", "AnalyticsCoreStringId.SqlDSWizard_QueryNamePlaceholder"), queryName) : queryName;
                    };
                    ...
                    _this._disposables.push(_this._selectStatementControl = new Analytics.Wizard.Internal.SelectStatementQueryControl(new Analytics.Wizard.Internal.SelectQuerySqlTextProvider(QueryBuilder.Internal.wrapGetSelectStatement(_this._options.callbacks.selectStatement), _this._connection), _this._options.disableCustomSql));
                    _this._disposables.push(_this.selectedQueryType.subscribe(function (value) {
                        if (value === ConfigureQueryPage.SP_TEXT) {
                            _this[BaseWizard.__loadingStateFunctionName] && _this[BaseWizard.__loadingStateFunctionName](true);
                            ...
                            }).always(function (x) { return _this[BaseWizard.__loadingStateFunctionName] && _this[BaseWizard.__loadingStateFunctionName](false); });
                ...
                ConfigureQueryPage.prototype.runQueryBuilder = function () {
                    ...
                    if (query && query.type() === Data.Utils.SqlQueryType.tableQuery) {
                        query.name(this.queryName());
                        this.popupQueryBuilder.show(query, this._dataSource());
                    }
                    else {
                        this.popupQueryBuilder.show(new Data.TableQuery({ "@Name": this.queryName() }, this._dataSource()), this._dataSource());
                    }
                };
            ...
            function _registerConfigureQueryPage(factory, dataSourceWizardOptions) {
                factory.registerMetadata(Wizard.SqlDataSourceWizardPageId.ConfigureQueryPage, {
                    ...
                    description: DevExpress.Analytics.Internal.isCustomizedWithUpdateLocalizationMethod("Create a query or select a stored procedure") || DevExpress.Analytics.Utils.getLocalization("Create a query or select a stored procedure.", DevExpress.Analytics.Internal.StringId.WizardPageConfigureQuery)
                });
            }
            ...
            var MultiQueryConfigurePage = (function (_super) {
                ...
                MultiQueryConfigurePage.prototype._createTreeListFactory = function () {
                    return new Internal.MultiQueryTreeListItemFactory();
                };
            ...
            var DataSourceWizardPageIterator = (function (_super) {
                ...
                DataSourceWizardPageIterator.prototype.getNextPageId = function (pageId) {
                    ...
                    else if (this._dataSourceWizardOptions.allowCreateNewJsonConnection && pageId === Wizard.DataSourceWizardPageId.ChooseDataSourceTypePage && this._getCurrentState().dataSourceType === DataSourceType.Json) {
                    ...
                    else if (this._dataSourceWizardOptions.allowCreateNewJsonConnection && pageId === Wizard.JsonDataSourceWizardPageId.ChooseConnectionPage && !this._getCurrentState().jsonDataSourceWizard.connectionName) {
                        return Wizard.JsonDataSourceWizardPageId.ChooseJsonSourcePage;
                    }
            ...
            var MultiQueryDataSourceWizardPageIterator = (function (_super) {
                ...
                MultiQueryDataSourceWizardPageIterator.prototype.getNextPageId = function (pageId) {
                    ...
                    else if (pageId === Wizard.DataSourceWizardPageId.ChooseDataSourceTypePage && this._getCurrentState().dataSourceType === DataSourceType.Object) {
                        return Wizard.ObjectDataSourceWizardPageId.ChooseTypesPage;
                    }
                    else if (pageId === Wizard.ObjectDataSourceWizardPageId.ChooseTypesPage && this._getCurrentState().objectDataSourceWizard.selectedType) {
                        return Wizard.ObjectDataSourceWizardPageId.ChooseDataMembersPage;
                    }
                    else if (pageId === Wizard.ObjectDataSourceWizardPageId.ChooseDataMembersPage) {
                        return Wizard.ObjectDataSourceWizardPageId.ConfigureParametersPage;
                    }
                    ...
                    else if (this._wizardOptions.allowCreateNewJsonConnection && pageId === Wizard.DataSourceWizardPageId.ChooseDataSourceTypePage && this._getCurrentState().dataSourceType === DataSourceType.Json) {
                        return Wizard.JsonDataSourceWizardPageId.ChooseJsonSourcePage;
                    }
                    else if (pageId === Wizard.JsonDataSourceWizardPageId.ChooseConnectionPage && this._getCurrentState().jsonDataSourceWizard.connectionName) {
                        return Wizard.JsonDataSourceWizardPageId.ChooseJsonSchemaPage;
                    }
                    else if (this._wizardOptions.allowCreateNewJsonConnection && pageId === Wizard.JsonDataSourceWizardPageId.ChooseConnectionPage && !this._getCurrentState().jsonDataSourceWizard.connectionName) {
                        return Wizard.JsonDataSourceWizardPageId.ChooseJsonSourcePage;
                    }
                    else if (pageId === Wizard.JsonDataSourceWizardPageId.ChooseJsonSourcePage) {
                        return Wizard.JsonDataSourceWizardPageId.ChooseJsonSchemaPage;
            ...
            function _registerMultiQueryDataSourcePages(factory, dataSourceWizardOptions) {
                ...
                _registerChooseJsonSchemaPage(factory, dataSourceWizardOptions.requestWrapper, dataSourceWizardOptions.callbacks);
                _registerChooseSqlConnectionPage(factory, dataSourceWizardOptions.connectionStrings.sql);
                Wizard._registerSpecifyObjectDataSourceSettingsPage(factory, dataSourceWizardOptions);
            ...
            var FullscreenWizardPage = (function (_super) {
                ...
                FullscreenWizardPage.prototype._getPageStyle = function (position, isVisible) {
                    ...
                    return Internal.getSectionStyle(position, this._defaultMargin, isVisible);
                };
            ...
            var SpecifyJsonDataSourceSettingsPage = (function (_super) {
                ...
                SpecifyJsonDataSourceSettingsPage.prototype.registerSections = function () {
                    if (this._dataSourceWizardOptions.connectionStrings.json().length > 0) {
                        Analytics.Wizard._registerSpecifyJsonConnectionPage(this._factory, this._dataSourceWizardOptions.connectionStrings.json, this._dataSourceWizardOptions.allowCreateNewJsonConnection, this._dataSourceWizardOptions.callbacks.getItemsProviderCallback);
                    ...
                    if (this._dataSourceWizardOptions.allowCreateNewJsonConnection) {
                        if (this._dataSourceWizardOptions.connectionStrings.json().length === 0) {
                            Analytics.Wizard._registerChooseJsonSourcePage(this._factory, this._dataSourceWizardOptions.requestWrapper, this._dataSourceWizardOptions.callbacks.getItemsProviderCallback);
                    ...
                    Analytics.Wizard._registerChooseJsonSchemaPage(this._factory, this._dataSourceWizardOptions.requestWrapper, this._dataSourceWizardOptions.callbacks);
                ...
                SpecifyJsonDataSourceSettingsPage.prototype.canNext = function () {
                    var section = this._sectionsProcessor.getPageById(Analytics.Wizard.FullscreenDataSourceWizardSectionId.ChooseJsonSchemaPage);
            ...
            var SpecifySqlDataSourceSettingsPage = (function (_super) {
                ...
                SpecifySqlDataSourceSettingsPage.prototype.getNextSectionId = function (sectionId) {
                    if (!sectionId)
                        ...
                        var sqlDataSourceWrapped = Analytics.Wizard._restoreSqlDataSourceFromState(sqlDataSourceWizardState);
                        if (sqlDataSourceWrapped.sqlDataSource.queries().length > 1) {
            ...
            var FullscreenDataSourceWizard = (function (_super) {
                ...
                FullscreenDataSourceWizard.prototype.initialize = function (state, createIterator) {
                    ...
                    else if (this._dataSourceWizardOptions.objectDataSourceAvailable || !Analytics.Internal.isEmptyObject(state.objectDataSourceWizard)) {
                        state.dataSourceType = DataSourceType.Object;
                    }
                    _super.prototype.initialize.call(this, state, createIterator);
                };
            ...
            var FullscreenDataSourceWizardPageIterator = (function (_super) {
                ...
                FullscreenDataSourceWizardPageIterator.prototype.getNextPageId = function (pageId) {
                    if (!pageId && this._isMoreThanOneDataSourceTypeAvailable())
                        ...
                        return Wizard.FullscreenDataSourceWizardPageId.SpecifyObjectDataSourceSettingsPage;
                    }
            ...
            (function (Legacy) {
                ...
                var MultiQueryDataSourceWizard = (function (_super) {
                    ...
                    function MultiQueryDataSourceWizard(connectionStrings, wizardSettings, callbacks, disableCustomSql, rtl) {
                        ...
                        _this.steps = [
                            ...
                            new JsonDataSourceJsonSourcePage(_this, callbacks.getItemsProviderCallback && callbacks.getItemsProviderCallback()),
                ...
                var JsonDataSourceJsonSourcePage = (function (_super) {
                    ...
                    function JsonDataSourceJsonSourcePage(wizard, itemsProvider) {
                        var _this = _super.call(this, wizard) || this;
                        ...
                        _this._jsonUriSetting = new Internal.JsonDataSourceJsonSourcePageUriSettings(_this._requestWrapper, itemsProvider);
                ...
                var CreateQueryPage = (function (_super) {
                    ...
                    function CreateQueryPage(wizard, callbacks, disableCustomSql, rtl) {
                        ...
                        _this.description = DevExpress.Analytics.Internal.isCustomizedWithUpdateLocalizationMethod("Create a query or select a stored procedure") || DevExpress.Analytics.Utils.getLocalization("Create a query or select a stored procedure.", DevExpress.Analytics.Internal.StringId.WizardPageConfigureQuery);
                ...
                var SelectConnectionString = (function (_super) {
                    ...
                    function SelectConnectionString(wizard, connectionStrings, _showPageForSingleConnectionString) {
                        ...
                        _this.description = Analytics.Internal.isCustomizedWithUpdateLocalizationMethod("Choose a data connection") || Analytics.Utils.getLocalization("Choose a data connection.", "AnalyticsCoreStringId.SqlDSWizard_PageChooseConnection");
                ...
                var JsonDataSourceJsonSourcePageUriSettings = (function (_super) {
                    ...
                    function JsonDataSourceJsonSourcePageUriSettings(_requestWrapper, _itemsProvider) {
                        ...
                        _this._sourceUriValidationCallback = function (params) {
                            if (!_this.sourceUri()) {
                                ...
                                params.rule.message = getLocalizedValidationErrorMessage(null, Analytics.Utils.getLocalization("Web Service Endpoint (URI):", "DataAccessUIStringId.WizardPageChooseJsonSource_URI"));
                                return false;
                            }
                    ...
                    JsonDataSourceJsonSourcePageUriSettings.prototype._getParametersInfo = function () {
                        ...
                        var parameters = {
                            ...
                            array: true,
                            addHandler: function () {
                                var newName = Analytics.Internal.getUniqueNameForNamedObjectsArray(_this.parameters(), "parameter");
                                return Data.JsonParameter.from({ "@Name": newName });
                            },
                        ...
                        parameters.editorOptions = {
                            ...
                            nameValidationRules: [{
                                    type: "required",
                                    get message() {
                                        return getLocalizedValidationErrorMessage(null, Analytics.Utils.getLocalization(parameters.displayName, parameters.localizationId), this._collectionItemNamePlaceholder);
                                    }
                                }]
                        };
                        return parameters;
                    ...
                    JsonDataSourceJsonSourcePageUriSettings.prototype.onChange = function (_onChange) {
                        ...
                        (_a = this._disposables).push.apply(_a, Internal.subscribeProperties([this.sourceUri, this.basicHttpAuth.password, this.basicHttpAuth.userName, this.resultUri], localOnChange));
                        this._disposables.push(Internal.subscribeArray(this.parameters, function (item) {
                            var _a;
                            (_a = item._disposables).push.apply(_a, Internal.subscribeProperties([item.name, item.itemType, item.value], localOnChange));
                        }, localOnChange));
                    };
            ...
            (function (Internal) {
                ...
                }(Analytics.Widgets.Internal.TreeListItemViewModel));
                Internal.CustomQueryTreeListItem = CustomQueryTreeListItem;
                ...
                }(Analytics.Widgets.Internal.DefaultTreeListItemFactory));
                Internal.MultiQueryTreeListItemFactory = MultiQueryTreeListItemFactory;
                ...
                Internal.getSectionStyle = getSectionStyle;
                ...
                Internal.ParametersTreeListItemBase = ParametersTreeListItemBase;
                ...
                Internal.ParametersTreeListRootItemBase = ParametersTreeListRootItemBase;
                        ...
                        this.getItems = function (pathRequest) {
                            ...
                            if (!pathRequest.fullPath) {
                                ...
                                var queries = customQueries().map(function (query) {
                                    ...
                                    if (currentQuery)
                                        return currentQuery;
                                    var queryNode = new TreeQueryNode(name, name, "query", !!currentQuery && currentQuery.checked(), query.parameters, _this._callBack, afterCheckToggled, query);
                ...
                var SelectStatementQueryControl = (function (_super) {
                    ...
                    function SelectStatementQueryControl(sqlTextProvider, disableCustomSql) {
                        ...
                        _this.aceOptions = DevExpress.QueryBuilder.Widgets.Internal.createDefaultSQLAceOptions();
                        _this.additionalOptions = DevExpress.QueryBuilder.Widgets.Internal.createDefaultSQLAdditionalOptions(function (newVal) { _this.sqlString(newVal); });
                        _this.aceAvailable = DevExpress.Analytics.Widgets.Internal.aceAvailable;
                        _this.languageHelper = DevExpress.QueryBuilder.Widgets.Internal.createDefaultSQLLanguageHelper();
                        _this.caption = function () { return DevExpress.Analytics.Utils.getLocalization("SQL string:", "DataAccessUIStringId.QueryControl_SqlString"); };
        ...
        (function (Widgets) {
            ...
            (function (Internal) {
                ...
                var OperandParameterQBSurface = (function (_super) {
                    ...
                    OperandParameterQBSurface.prototype._createParameter = function (name, dataType) {
                        if (name !== "" && name !== OperandParameterQBSurface.defaultDisplay() && this.helper.parameters().filter(function (parameter) { return parameter.name() === name; }).length === 0) {
                            var parameter = new QueryBuilder.Elements.ParameterViewModel({ "@Name": name, "@Type": dataType });
                ...
                function isAggregatedExpression(object) {
                    return object.aggregate() !== QueryBuilder.Elements.Metadata.AggregationType.None;
                }
                ...
                var QBFilterEditorHelper = (function (_super) {
                    ...
                    function QBFilterEditorHelper(parametersMode) {
                        ...
                        if (parametersMode === QueryBuilder.Elements.Metadata.ParametersMode.ReadWrite) {
                ...
                var QBFilterStringOptions = (function (_super) {
                    ...
                    QBFilterStringOptions.prototype.initializeFilterStringHelper = function (parameters, parametersMode, serializer) {
                        ...
                        helper.canChoiceParameters = parametersMode !== QueryBuilder.Elements.Metadata.ParametersMode.Disabled;
                        if (serializer) {
                        ...
                        if (parametersMode === QueryBuilder.Elements.Metadata.ParametersMode.ReadWrite) {
                            ...
                            if (parametersMode === QueryBuilder.Elements.Metadata.ParametersMode.Read)
                            ...
                            helper.criteriaTreeValidator._checkRightPart = function (criteriaOperator) {
                                ...
                                if (parametersMode === QueryBuilder.Elements.Metadata.ParametersMode.Disabled) {
                                    return false;
                                }
                                else if (parametersMode === QueryBuilder.Elements.Metadata.ParametersMode.Read) {
            ...
            (function (Internal) {
                var ObjectTypeDescriptions = (function () {
                    function ObjectTypeDescriptions(model) {
                        var types = Data.Internal.deserializeToCollection(model, function (key) { return new Data.ObjectType(key); });
                        this.types = types.sort(function (a, b) { return a.displayName.localeCompare(b.displayName); });
                    }
                    return ObjectTypeDescriptions;
                }());
                Internal.ObjectTypeDescriptions = ObjectTypeDescriptions;
                ...
                Internal.getObjectTypeDescriptionsCallback = getObjectTypeDescriptionsCallback;
                var ObjectSchemaProvider = (function (_super) {
                    ...
                    ObjectSchemaProvider.prototype.getSchemaByPath = function (pathRequest, objectSchema) {
                        if (!pathRequest.fullPath) {
                            return objectSchema.types.map(function (type) { return $.extend({}, type, { isList: true, specifics: "List" }); });
                        }
                        else {
                            var currentCtros = [];
                            for (var i = 0; i < pathRequest.pathParts.length; i++) {
                            ...
                            return currentCtros.map(function (ctor) { return $.extend({}, ctor, { isList: false, specifics: "default" }); });
                        }
                    };
                ...
                Internal.ObjectSchemaProvider = ObjectSchemaProvider;
                ...
                Internal.ChooseObjectTypesTreelistController = ChooseObjectTypesTreelistController;
                ...
                Internal.ChooseObjectTypes = ChooseObjectTypes;
                var ObjectDataSourceParameterProperty = (function (_super) {
                    ...
                    function ObjectDataSourceParameterProperty(_parameter, _itemsProvider) {
                        ...
                        var typeValue = Data.DataSourceParameter._getTypeValue(_this._parameter.resultType);
                        _this._initGetInfo(typeValue);
                        new Analytics.Utils.ModelSerializer().deserialize(_this, {});
                    ...
                    ObjectDataSourceParameterProperty.prototype.switchPropertyType = function () {
                        if (this.isExpression()) {
                            ...
                            this.type(Analytics.Internal.ExpressionType);
                    ...
                    ObjectDataSourceParameterProperty.prototype._generateInfo = function (info, propertyName) {
                        ...
                        return Analytics.Internal.extend({}, {
                    ...
                    ObjectDataSourceParameterProperty.prototype._initGetInfo = function (typeValue) {
                        ...
                        var info = [
                            this._generateInfo({
                                editor: Analytics.Internal.getEditorType(this._parameter.resultType),
                ...
                Internal.ObjectDataSourceParameterProperty = ObjectDataSourceParameterProperty;
                ...
                }(Analytics.Widgets.ObjectProperties));
                ...
                Internal.ObjectDataSourceParametersModel = ObjectDataSourceParametersModel;
                ...
                Internal.ChooseObjectMemberParameters = ChooseObjectMemberParameters;
                ...
                Internal.ChooseObjectParameters = ChooseObjectParameters;
                ...
                Internal.ChooseObjectDataMembers = ChooseObjectDataMembers;
            })(Internal = Wizard.Internal || (Wizard.Internal = {}));
        })(Wizard = Analytics.Wizard || (Analytics.Wizard = {}));
        var Data;
        (function (Data) {
            var ObjectDataSource = (function (_super) {
                ...
                ObjectDataSource.prototype.setState = function (state) {
                    ...
                    this.id = Analytics.Internal.guid().replace(/-/g, "");
                    this.name(state.dataSourceName);
                };
                return ObjectDataSource;
            }(Analytics.Utils.Disposable));
            Data.ObjectDataSource = ObjectDataSource;
            ...
            Data.ObjectDataMemberBase = ObjectDataMemberBase;
            ...
            Data.ObjectParameter = ObjectParameter;
            var ObjectDataSourceMethodBase = (function (_super) {
                ...
                function ObjectDataSourceMethodBase(model) {
                    var _this = _super.call(this, model) || this;
                    _this.parameters = Data.Internal.deserializeToCollection(model.parameters, function (parameters) { return new ObjectParameter(parameters); });
                    return _this;
                }
                return ObjectDataSourceMethodBase;
            }(ObjectDataMemberBase));
            Data.ObjectDataSourceMethodBase = ObjectDataSourceMethodBase;
            var ObjectDataMember = (function (_super) {
                ...
                ObjectDataMember.entireObject = function () { return Analytics.Utils.getLocalization("Entire Object", "AnalyticsCoreStringId.ObjectDSWizard_ConfigureParameters_EntireObject"); };
                return ObjectDataMember;
            }(ObjectDataSourceMethodBase));
            Data.ObjectDataMember = ObjectDataMember;
            ...
            Data.ObjectCtor = ObjectCtor;
            var ObjectType = (function (_super) {
                __extends(ObjectType, _super);
                function ObjectType(model) {
                    var _this = _super.call(this, model) || this;
                    _this.ctors = Data.Internal.deserializeToCollection(model.ctors, function (ctor) { return new ObjectCtor(ctor); });
                    _this.members = Data.Internal.deserializeToCollection(model.members, function (member) { return new ObjectDataMember(member); });
                    return _this;
                }
        ...
        (function (Wizard) {
            var SpecifyObjectDataSourceSettingsPage = (function (_super) {
                ...
                function SpecifyObjectDataSourceSettingsPage(_dataSourceWizardOptions) {
                    ...
                    _this._disposables.push(_this._provider = new Wizard.Internal.ObjectSchemaProvider(_this._dataSourceWizardOptions.requestWrapper), _this._chooseObjectType = new Wizard.Internal.ChooseObjectTypes(_this._types, _this._provider), _this._chooseObjectDataMember = new Wizard.Internal.ChooseObjectDataMembers(_this._chooseObjectType.selectedType, _this._chooseObjectType.selectedCtor), _this._chooseObjectParameters = new Wizard.Internal.ChooseObjectParameters(_this._chooseObjectType.selectedCtor, _this._chooseObjectDataMember.selectedDataMembers, getItemsProviderCallback && getItemsProviderCallback()));
                    _this._initSections();
                    return _this;
                }
                    ...
                    this._sections = [
                        {
                            ...
                            description: Analytics.Utils.getLocalization("Choose the type and its constructor.", "AnalyticsCoreStringId.ObjectDSWizard_ChooseType_Description"),
                            position: Wizard.Internal.getSectionStyle(this._dataSourceWizardOptions.rtl ? Wizard.WizardSectionPosition.Right : Wizard.WizardSectionPosition.Left),
                        ...
                        },
                        {
                            ...
                            description: Analytics.Utils.getLocalization("Choose the entire object or a data member to bind.", "AnalyticsCoreStringId.ObjectDSWizard_ChooseDataMember_Description"),
                            position: Wizard.Internal.getSectionStyle(this._dataSourceWizardOptions.rtl ? Wizard.WizardSectionPosition.TopLeft : Wizard.WizardSectionPosition.TopRight),
                            disabledText: Analytics.Utils.getLocalization("To select a data member, choose a type that contains at least one data member.", "AnalyticsCoreStringId.ObjectDSWizard_ChooseDataMember_Disabled_Description"),
                        ...
                        },
                        {
                            ...
                            position: Wizard.Internal.getSectionStyle(this._dataSourceWizardOptions.rtl ? Wizard.WizardSectionPosition.BottomLeft : Wizard.WizardSectionPosition.BottomRight),
                            description: Analytics.Utils.getLocalization("Configure constructor parameters and/or method parameters.", "AnalyticsCoreStringId.ObjectDSWizard_ConfigureParameters_Description"),
                            disabledText: Analytics.Utils.getLocalization("To specify parameters, select a parameterized constructor or method.", "AnalyticsCoreStringId.ObjectDSWizard_ConfigureParameters_Disabled_Description"),
            ...
            Wizard.SpecifyObjectDataSourceSettingsPage = SpecifyObjectDataSourceSettingsPage;
            function _registerSpecifyObjectDataSourceSettingsPage(factory, dataSourceWizardOptions) {
                factory.registerMetadata(Wizard.FullscreenDataSourceWizardPageId.SpecifyObjectDataSourceSettingsPage, {
                    setState: function (data, state) {
            ...
            Wizard._registerSpecifyObjectDataSourceSettingsPage = _registerSpecifyObjectDataSourceSettingsPage;
        })(Wizard = Analytics.Wizard || (Analytics.Wizard = {}));
    })(Analytics = DevExpress.Analytics || (DevExpress.Analytics = {}));
    (function (QueryBuilder) {
        var Metadata;
        (function (Metadata) {
            Metadata.name = { propertyName: "name", modelName: "@Name", displayName: "Name", localizationId: "DevExpress.DataAccess.Sql.SqlQuery.Name", disabled: true, editor: QueryBuilder.Widgets.editorTemplates.text };
            Metadata.alias = { propertyName: "alias", modelName: "@Alias", displayName: "Alias", localizationId: "DataAccessUIStringId.QueryBuilderColumns_Alias", defaultVal: "", editor: QueryBuilder.Widgets.editorTemplates.text };
            Metadata.text = { propertyName: "text", modelName: "@Text", displayName: "Text", editor: QueryBuilder.Widgets.editorTemplates.text };
            Metadata.selected = { propertyName: "selected", displayName: "Output", editor: QueryBuilder.Widgets.editorTemplates.bool, localizationId: "DataAccessUIStringId.QueryBuilderColumns_Output" };
        ...
        (function (Internal) {
            ...
            function _createQueryBuilder(element, data, callbacks, localization, rtl) {
                ...
                var init = function (querySource) {
                    ...
                    treeListOptions({
                        ...
                        treeListController: new Internal.QueryBuilderTreeListController(designerModel.undoEngine, query),
                ...
                var tablesTop = ko.observable(355), itemPropertiesTabInfoModel = {
                    ...
                    tablesTop: tablesTop,
                    searchPlaceholder: function () { return Analytics.Internal.searchPlaceholder(); }
                };
                ...
                designerModel.fieldListProvider = new QueryBuilder.Widgets.Internal.QueryBuilderObjectsProvider(query, QueryBuilder.Widgets.Internal.QueryBuilderObjectsProvider.whereClauseObjectsFilter);
                ...
                designerModel.dataBindingsGroupProvider = new QueryBuilder.Widgets.Internal.QueryBuilderObjectsProvider(query, QueryBuilder.Widgets.Internal.QueryBuilderObjectsProvider.groupByObjectsFilter);
            ...
            ko.bindingHandlers['dxdTableView'] = {
                init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
                    var templateHtml = DevExpress.Analytics.Widgets.Internal.getTemplate('dxd-tableview'), $element = $(element).append(templateHtml), $titles, $content, rtl = !!bindingContext.$root.rtl, value = ko.unwrap(valueAccessor());
        ...
        (function (Elements) {
            ...
            var ColumnViewModel = (function (_super) {
                ...
                function ColumnViewModel(model, dbColumn, parent, serializer) {
                    ...
                    _this._type = ko.observable(Analytics.Data.DBColumnType.Unknown);
                    ...
                    _this.displayType = ko.pureComputed(function () {
                        return Analytics.Data.DBColumnType[_this._type()] + (_this._size() ? '(' + _this._size() + ')' : "");
                    });
                    _this.dataType = ko.pureComputed(function () {
                        return Analytics.Data.DBColumn.GetType(_this._type());
                    });
            ...
            var ColumnSurface = (function (_super) {
                ...
                function ColumnSurface(control, context) {
                    ...
                    _this.isAggregate = ko.pureComputed(function () { return QueryBuilder.Widgets.Internal.isAggregatedExpression(_this.getControlModel()); });
            ...
            (function (Metadata) {
                ...
                Metadata.joinConditionSerializationInfo = [
                    { propertyName: "left", displayName: "Left", editor: QueryBuilder.Widgets.editorTemplates.text, disabled: true, localizationId: "AnalyticsCoreStringId.QueryBuilder_LeftOperand" },
                    { propertyName: "right", displayName: "Right", editor: QueryBuilder.Widgets.editorTemplates.text, disabled: true, localizationId: "AnalyticsCoreStringId.QueryBuilder_RightOperand" },
            ...
            var ParameterViewModel = (function (_super) {
                ...
                ParameterViewModel.prototype.getEditorType = function (type) {
                    if (Analytics.Internal.IsDataAccessExpression(type))
            ...
            var QueryViewModel = (function (_super) {
                ...
                function QueryViewModel(querySource, dbSchemaProvider, parametersMode, serializer) {
                    ...
                    _this.tables().forEach(function (table) {
                        ...
                        [_this.columns(), _this.sorting(), _this.grouping()].forEach(function (currentColumns) {
                            currentColumns.forEach(function (column) {
                                if (table.name() === column.table() && column.itemType() === Metadata.ColumnType.Column &&
                    ...
                    _this.filterString = new QueryBuilder.Widgets.Internal.QBFilterStringOptions(_this._filterString, null, ko.pureComputed(function () { return (_this.tables().length === 0) && (_this.filterString && _this.filterString.value().length === 0); }));
                    ...
                    _this.groupFilterString = new QueryBuilder.Widgets.Internal.QBFilterStringOptions(_this._groupFilterString, null, ko.pureComputed(function () { return !_this.columns().some(QueryBuilder.Widgets.Internal.isAggregatedExpression) && (_this.groupFilterString && (_this.groupFilterString.value() || '').length === 0); }));
                    _this.groupFilterString.initializeFilterStringHelper(_this.parameters, parametersMode, new QueryBuilder.Widgets.Internal.GroupFilterEditorSerializer(_this.columns));
                ...
                QueryViewModel.prototype._addColumnsToTable = function (table, columns) {
                    table._initColumns(columns.map(function (x) {
                        return new Analytics.Data.DBColumn({
                            Name: x.column()
                        });
                    }));
                };
                ...
                QueryViewModel.prototype.canSave = function (showMessage) {
                    ...
                    this.tables().forEach(function (t) {
                        t.getInvalidColumns().forEach(function (column) {
                            message.push(Analytics.Internal.formatUnicorn(Analytics.Utils.getLocalization("The schema does not contain the following column: \"{0}\".\"{1}\".", "DataAccessStringId.ColumnNotInSchemaValidationException"), t.actualName(), column.actualName()));
                        });
                    });
                    if (message.length > 0) {
                        showMessage && Analytics.Internal.ShowMessage(message.join("\n"), "error");
                        return false;
                    }
                    return true;
                };
                            ...
                            dbSourceTable.foreignKeys.forEach(function (fk) {
                                ...
                                if (pkTable) {
                                    for (var i = 0; i < fk.primaryKeyColumns.length; i++) {
                                        var column1 = Analytics.Internal.getFirstItemByPropertyValue(sourceTable.columns(), "name", fk.columns[i]);
                                        var column2 = Analytics.Internal.getFirstItemByPropertyValue(pkTable.columns(), "name", fk.primaryKeyColumns[i]);
                                        if (column1 && column2) {
                            ...
                            if (dbTable) {
                                dbTable.foreignKeys.forEach(function (fk) {
                                    if (fk.primaryKeyTable === sourceTable.name()) {
                                        for (var i = 0; i < fk.primaryKeyColumns.length; i++) {
                                            var column1 = Analytics.Internal.getFirstItemByPropertyValue(sourceTable.columns(), "name", fk.primaryKeyColumns[i]);
                                            var column2 = Analytics.Internal.getFirstItemByPropertyValue(table.columns(), "name", fk.columns[i]);
                                            if (column1 && column2) {
            ...
            (function (Metadata) {
                Metadata.querySerializationsInfo = [
                    ...
                    { propertyName: "itemType", modelName: "@ItemType" },
                    { propertyName: "allColumnsInTablesSelected", displayName: "Select All (*)", localizationId: "AnalyticsCoreStringId.QueryBuilder_SelectAll", editor: QueryBuilder.Widgets.editorTemplates.bool },
                    { propertyName: "top", modelName: "@Top", displayName: "Select Top", defaultVal: 0, from: Analytics.Utils.floatFromModel, localizationId: "AnalyticsCoreStringId.QueryBuilder_SelectTop", editor: QueryBuilder.Widgets.editorTemplates.numeric, editorOptions: { format: "#0", min: 0 } },
                    { propertyName: "skip", modelName: "@Skip", displayName: "Offset", defaultVal: 0, from: Analytics.Utils.floatFromModel, localizationId: "AnalyticsCoreStringId.QueryBuilder_Offset", editor: QueryBuilder.Widgets.editorTemplates.numeric, editorOptions: { format: "#0", min: 0 } },
                    { propertyName: "distinct", modelName: "@Distinct", defaultVal: false, from: Analytics.Utils.parseBool, displayName: "Select distinct", localizationId: "AnalyticsCoreStringId.QueryBuilder_SelectDistinct", editor: QueryBuilder.Widgets.editorTemplates.bool }
                ];
            })(Metadata = Elements.Metadata || (Elements.Metadata = {}));
            ...
            var TableViewModel = (function (_super) {
                ...
                TableViewModel.prototype._initColumns = function (columns, update) {
                    ...
                    columns.forEach(function (item) {
                        result.push(new ColumnViewModel({ "@Name": item.name }, item, _this, _this.serializer));
                    });
...
DevExpress.Analytics.Widgets.Internal.SvgTemplatesEngine.addTemplates({
    ...
    'dxrd-masterDetail-editor-complete-wizard': '<div class="dx-filtereditor dxrd-masterDetail-editor-complete-wizard dxd-border-secondary">        <!-- ko if: $data -->        <div class="dx-filtereditor-tree dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: \'onHover\', direction: \'both\' }" style="cursor: default">            <!-- ko foreach: masterQueries -->            <div class="criteria-operator-group">                <div class="criteria-operator-group-item">                    <div class="criteria-operator-text dxd-filter-editor-text-color criteria-operator-item-group dxd-filter-editor-group-back-color stylized" data-bind="text: queryName"></div>                    <div data-bind="service: { name: \'createRelation\' }"></div>                </div>                <div class="criteria-operator-content">                    <!-- ko template: { name: \'dx-masterDetail-editor-relation\', foreach: relations }-->                    <!-- /ko -->                </div>            </div>            <!-- /ko -->        </div>        <div class="dx-selectbox-popup-wrapper dx-dropdownlist-popup-wrapper dx-filtereditor-criteriaoperator-popup dx-dropdowneditor-overlay" data-bind="dxPopupWithAutoHeight: { width: \'170px\', height: \'235px\', focusStateEnabled: false,        position: $root.rtl ? { my: \'right top\', at: \'right bottom\', of: popupService.target } : { my: \'left top\', at: \'left bottom\', of: popupService.target },        container: $root.getPopupContainer($element),        target: popupService.target,        showTitle: false,        showCloseButton: false,        animation: {},        closeOnOutsideClick: true,        shading: false,        visible: popupService.visible }">            <!-- ko with: popupService-->            <!-- ko with: data -->            <!-- ko template: template-->            <!-- /ko -->            <!-- /ko -->            <!-- /ko -->        </div>        <!-- /ko -->    </div>',
    ...
    'dx-wizard-newlayout': '<div class="dxrd-wizard dx-editors dxd-text-primary" data-bind="dxPopup: {        visible: isVisible,        title: isVisible() ? title : \'\',        showTitle: true,        fullScreen: false,        width: width,        height: height,        container: _container($element),        titleTemplate: _titleTemplate,        position: _wizardPopupPosition($element)    }, cssArray: [ $data._extendCssClass, { \'dx-rtl\': $root.rtl, \'dx-ltr\': !$root.rtl }]">        <div class="dxrd-wizard-content">            <!-- ko with: _currentPage -->            <div style="height: 100%" data-bind="template: { name: template, data: page } "></div>            <!-- /ko -->            <div class="dxrd-wizard-load-panel dxd-text-primary" data-bind="dxLoadPanel: _loadPanelViewModel($element)"></div>        </div>        <div class="dxrd-wizard-navigation">            <div data-bind="dxButton: cancelButton" class="dxrd-wizard-btn left"></div>            <div data-bind="dxButton: finishButton" class="dxrd-wizard-btn right"></div>            <div data-bind="dxButton: nextButton" class="dxrd-wizard-btn right"></div>            <div data-bind="dxButton: previousButton" class="dxrd-wizard-btn right"></div>        </div>    </div>',
});
