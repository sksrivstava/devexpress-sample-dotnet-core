<!--
/**
* DevExpress HTML/JS Analytics Core (templates.html)
* Version: 20.1.6
...
<script type='text/html' id='dxdd-routed-connection-line'>
    <svg class="dxdd-connection-line">
        ...
        <!-- /ko -->
        <polyline class="dxd-qb-relationship-line-color" fill="none" data-bind="attr: { points: routePointsSet, 'marker-end': showArrow() ? 'url(#dxqb-arrow_' + connectorID() + ')' : '' }, updateConnectorArrow: $data" />
    </svg>
</script>
...
<script type='text/html' id='dxdd-routed-connector'>
    <div class="dxdd-connector" data-bind="styleunit: position, visible: isVisible">
        ...
        <div data-bind="styleunit: position" style="position: absolute;">
            <!-- ko with: $parent -->
            <div class="dxd-selectable" data-bind="trackCursor: underCursor, click: $root.selectItemProperties" style="position: relative; width: 100%; height: 100%;"></div>
            <!-- /ko -->
        </div>
        <!-- /ko -->
    </div>
                    ...
                    <div class="dxrd-ghost-containment" style="height:100%;">
                        <div class="dxrd-ghost-container dxqb-ghost-container" data-bind="styleunit: { 'minWidth': pageWidth, 'minHeight': pageHeight }, trackCursor: underCursor">
                            <div class="dxqb-main" data-bind="trackCursor: underCursor, style: { 'z-index' : $parent.dragDropStarted() ? 2 : null }">
                                ...
                                <!-- /ko -->
                                <div class="dxrd-drag-helper-source" data-bind="styleunit: { top: $root.dragHelperContent.top, left: $root.dragHelperContent.left, width: $root.dragHelperContent.width, height: $root.dragHelperContent.height }" style="display:none">
                                    <!-- ko if: !$root.dragHelperContent._isEmpty -->
                                    <!-- ko foreach: $root.dragHelperContent.controls -->
    ...
    <div class="dxqb-table dxd-qb-table-back-color dxd-back-primary2">
        <div class="dx-border-inheritor dxd-border-accented">
            <div class="dxqb-table-head-field dxd-qb-table-field-border-color dxd-qb-table-field-back-color dxd-back-highlighted dxd-border-primary">
                ...
                <div class="dxqb-table-title dxd-text-primary" data-bind="text: getControlModel().actualName, style: { cursor: selected() ? 'move' : 'default' }"></div>
            </div>
        </div>
...
<script type="text/html" id="dxrd-masterDetail-editor">
    ...
    <div>
        <div class="dx-filtereditor" data-bind="dxPopup: { showTitle: true, width: '95%', height: '95%', title: title(), visible: popupVisible,
            ...
            <div class="dx-filtereditor-tree dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', direction: 'both' }" style="cursor: default">
...
<script type='text/html' id='dxqb-properties-wrapper'>
    <div class="dxrd-properties-wrapper" data-bind="visible: active() && visible()">
        <div style="height:100%" class="dxd-text-primary">
            <!-- ko with: model -->
            <div class="dxrd-properties-grid dxd-border-primary" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true }" style="top: 0px;">
                <div>
                    <!-- ko foreach: groups -->
...
<script type="text/html" id="dxqb-parameterspanel">
    ...
    <div class="dxqb-right-panel-parameters" data-bind="dxScrollView: { showScrollbar: 'onHover', scrollByContent: false, scrollByThumb: true, bounceEnabled: false, useNative: false }">
        <div style="width: 100%" data-bind="dxCollectionEditor: $data"></div>
    </div>
    <!-- /ko -->
</script>
<script type="text/html" id="dxqb-collectioneditor-template">
    <div class="dxrd-accordion-collection-item" data-bind="dxdAccordion: { collapsed: collapsed }">
        <div class="dxrd-group-header dx-accordion-header">
            <div>
                <div class="propertygrid-editor-collapsed dx-collapsing-image" data-bind="css: { 'dx-image-expanded': !collapsed() }, template: 'dxrd-svg-collapsed'"></div>
        ...
        <div class="dx-accordion-content">
            <div data-bind="dxPropertyGrid: { target: value, level: 1, parentDisabled: editor.disabled }"></div>
        </div>
    </div>
</script>
<script type="text/html" id="dxqb-toolbar">
    <div class="dxrd-toolbar-wrapper dxd-toolbar-back-color" data-bind="click: $root.findControl">
        <div class="dxqb-toolbar-background dxd-back-primary2"></div>
        <div class="dxrd-toolbar" data-bind="template: {name: 'dxqb-toolbar-items', data: actionLists.toolbarItems }"></div>
    </div>
</script>

<script type="text/html" id="dxqb-toolbar-items">
    <!-- ko foreach: $data -->
    ...
    <div class="dxrd-toolbar-item" data-bind="visible: visible">
        <div class="dxqb-toolbar-item-container">
            <div class="dxqb-toolbar-item-background dxd-back-secondary"></div>
...
<script type="text/html" id="dxqb-expressionstring">
    <!-- ko if: $data.value() -->
        ...
        <div data-bind="dxdAccordion: { collapsed: collapsed }">
            <div class="dx-accordion-header">
                <div class="dx-filtereditor-popup-item dxd-list-item-back-color dx-item dx-list-item dxd-back-highlighted">
                    <div class="dx-collapsing-image" data-bind="template: 'dxrd-svg-collapsed', css: { 'dx-image-expanded': !collapsed() }" style="display:inline-block;  margin-left: 5px;"></div>
...
<script type="text/html" id="dxqb-treelist-header-item-with-search">
    <div class="dx-treelist-item dxd-list-item-back-color dxd-back-highlighted" data-bind="event: { dblclick: function() { $data.dblClickHandler ? $data.dblClickHandler($data) : $data.toggleCollapsed() } }, styleunit: padding, css: { 'dx-treelist-item-selected dxd-state-selected': isSelected() || isMultiSelected() }">
...
<script type="text/html" id="dxrd-page-choose-datasource-type">
    <div class="dxrd-wizard-type-page" data-bind="css: $data._extendCssClass('type-page')">
        ...
        <div data-bind="event: { click: $parent._itemClick, dblclick: function() { $parent._goToNextPage() } }, attr: { class: 'dxd-back-highlighted dxd-state-normal dxrd-wizard-type-item dx-fontsize-reestablished dxrd-wizard-type-item-border-color dxd-list-item-back-color ' + $parent._extendCssClass('type-item')}, css: { 'dxd-border-secondary dxd-back-secondary': $parent._IsSelected($data) } ">
            <div data-bind="attr: { class: 'dxrd-wizard-type-image ' + $parent._extendCssClass('type-image') }, css: imageClassName, template: imageTemplateName"> </div>
        ...
        <div class="dxrd-wizard dxrd-report-wizard dx-editors dxd-text-primary dxd-back-primary2" data-bind="css: _extendCssClass">
            <div class="dxrd-wizard-steps-container dxd-back-primary" data-bind="visible: $data.navigationPanel().isVisible">
                ...
                <div class="dxrd-wizard-steps" data-bind="foreach: _steps">
                    <div class="dxrd-wizard-steps-relative" style="position:relative" data-bind="visible: $data.visible">
...
<script type="text/html" id="dx-wizard-fullscreen-page">
    ...
    <div style="position:absolute;" data-bind="foreach: _sections, styleunit: { top: _parentMarginOffset, left: _parentMarginOffset, right: _parentMarginOffset, bottom: _parentMarginOffset }">
        <div class="dx-border-inheritor dxd-border-accented">
            <div class="dxrd-report-page-tile dxd-border-secondary" data-bind="css: { 'dxrd-disabled': !$data.page() }, style: $parent._pageCss[$data.pageId]">
                <div class="dxrd-report-page-tile-title" data-bind="visible: $parent._showPageDescription(), text: $parent._getPageDescription($index(), $data), attr: { title: $parent._getPageDescription($index(), $data) }"></div>
...
<script type="text/html" id="dxrd-jsondatasource-fields-page">
    <div class="dxrd-wizard-page dx-jsonschema-page dx-frameless-style">
        <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-dataMember dx-fieldset" style="height:100%">
            <div class="dx-field">
                <div class="dx-field-label" data-bind="text: _rootElementTitle"></div>
                <div class="dx-field-value" data-bind="dxSelectBox: { dataSource: _rootElementList, value: _selectedRootElement, displayExpr: 'fullPath', displayCustomValue: true, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
            </div>
            <div class="dxrd-wizard-add-queries-page dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover' }">
                <div data-bind="treelist: _fieldListModel" style="width:100%; height: 100%;"></div>
            </div>
        </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-page-jsonsource">
    <div class="dxrd-wizard-page dx-jsonsource-page dx-frameless-style">
        <div class="dx-default-border-style dxd-border-secondary dxrd-wizard-dataMember dx-fieldset" style="height: 100%" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true }, dxValidationGroup: $data._validationGroup || {}">
            <div class="dx-field">
...
<div class="dxrd-wizard-page">
    ...
    <div class="dxrd-wizard-datasourceoperation dxrd-radio-nowrap-ellipsis" style="margin-bottom: 15px" data-bind="dxRadioGroup: { value: selectedDataSourceOperation, items: dataSourceOperations, layout: 'vertical' }">
...
<script type="text/html" id="dxrd-page-selectitems-radio-group">
    <!-- ko if: canCreateNew -->
    <div class="dxrd-wizard-datasourceoperation dxrd-radio-nowrap-ellipsis" style="margin-bottom: 15px" data-bind="dxRadioGroup: { value: selectedOperation, items: operations, layout: 'vertical' }">
        <div data-options="dxTemplate : { name: 'item' }">
            <div class="dxrd-radio-nowrap-ellipsis-text" data-bind="text: text, attr: { 'title': text }"></div>
        </div>
    </div>
...
<div class="dxrd-wizard-page">
    ...
    <!-- /ko -->
    <!-- ko if: _createNew -->
    <div style="position:relative; top: 65px; height: calc(100% - 65px)">
...
<script type="text/html" id="dx-jsonwizard-parametercollection">
    <div class="dx-field">
        ...
        <div class="dx-jsonwizard-parameter-middle-container">
            <div data-bind="dxTextBox: { value: name, placeholder: $data.namePlaceholder() }, dxValidator: { validationRules: $parent.editor.editorOptions.nameValidationRules || [] }"></div>
        </div>
        <div class="dx-jsonwizard-parameter-right-container">
            <div class="dx-jsonwizard-parameter">
                ...
                <div data-bind="dxExpressionEditor: { options: _expression, fieldListProvider: $parent.editor.editorOptions.itemsProvider, displayNameProvider: $root.displayNameProvider && $root.displayNameProvider() }, visible: $data.isExpression"></div>
            </div>
        </div>
                        ...
                        <div class="dx-treelist-text-wrapper">
                         ...
                         return true;
                            ...
                            <div class="dx-treelist-text dx-treelist-text-with-checkbox">
                                <div class="dx-queryname-textbox" data-bind="dxTextBox: { value: queryName }"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="dx-background-inheritor dxd-back-highlighted dxd-state-selected">
    <div class="dx-treelist-item dx-fontsize-reestablished dxd-list-item-back-color" data-bind="event: {
        ...
        <div class="dx-treelist-caption">
            ...
            <div class="dx-treelist-selectedcontent" data-bind="event: { dblclick: function() { $data.dblClickHandler && $data.dblClickHandler($data); } }, click: toggleSelected,  draggable: isDraggable ? dragDropHandler : null">
                <div class="dx-treelist-text-wrapper">
                    ...
                    <!--ko if: treeListController.searchEnabled -->
                    <div class="dx-treelist-text dx-highlighted-search-text dx-treelist-text-with-checkbox" data-bind="searchHighlighting: { text: text, textToSearch: treeListController.textToSearch, searchOptions: treeListController.searchOptions }, attr: { title: text }"></div>
                    <!-- /ko  -->
                    <!--ko ifnot: treeListController.searchEnabled -->
...
<script type="text/html" id="dx-treelist-action-with-popover">
    <div class="dx-treelist-action-with-popover" style="display: inline-block">
        <div class="dx-treelist-action" data-bind="dxButtonWithTemplate: { onClick: function() { clickAction($parent); }, icon: $data.imageTemplateName, iconClass: $data.imageClassName , disabled: $data.disabled && $data.disabled() }, attr: { title: text }"></div>
        <div data-bind="dxPopover:{ width: 200, position: !$root.rtl ? 'left' : 'right', visible: $parent.data.popoverVisible, target: '.dx-treelist-action-with-popover', container: $root.getPopupContainer($element)}">
...
<script type="text/html" id="dxrd-page-objectdatasource-types">
    <div class="dx-objectdatasource-types-page">
        ...
        <div data-bind="dxScrollView: { showScrollbar: 'onHover', height: _chooseObjectType._scrollViewHeight}">
            ...
            <div class="dxa-no-data-message" data-bind="text: $root.dx.Analytics.Internal.noDataText()"></div>
            <!-- /ko-->
        </div>
    </div>
</script>
...
<script type="text/html" id="dxrd-parameter-collection-item">
    <div data-bind="dxdAccordion: { collapsed: collapsed }">
        <div class="dxrd-group-header dx-accordion-header dxd-text-primary" style="border-bottom: 0" data-bind="styleunit: { 'marginLeft' : editor.padding }, css: { 'dxrd-group-header-collapsed dxd-border-primary': collapsed() }">
            <div class="dx-collapsing-image" data-bind="template: 'dxrd-svg-collapsed', css: { 'dx-image-expanded': !collapsed() }" style="display:inline-block;"></div>
    ...
    <div class="dx-fieldset" style="height:100%">
        <div class="dx-collectioneditor" style="height:100%">
            <div class="dxrd-datasource-parameters-collection">
                <div class="dxrd-datasource-parameters-container dxd-border-secondary" data-bind="dxScrollView: { showScrollbar: 'onHover', useNative: false, scrollByThumb: true  }">
                    ...
                    <div class="dx-collectioneditor-items" data-bind="foreach: values">
                        <div class="dx-background-inheritor dxd-back-highlighted dxd-state-selected" data-bind="with: $parent.createCollectionItemWrapper($parents[1], $index, $element)">
                            <div class="dx-collectioneditor-item-container dx-fontsize-reestablished dxd-list-item-back-color" data-bind="dxclick: $parents[1].select, css: { 'dxd-state-selected dxd-back-secondary' : $parents[1].selectedIndex() === $index() }">
            ...
            <div class="dxrd-collectioneditor-wizard-buttons" data-bind="visible: showButtons">
                <div class="dxrd-collectioneditor-action" data-bind="dxButton: { onClick: add, text: getDisplayTextButton('add') }, attr: { title: getDisplayTextButton('add') }"></div>
                <div class="dxrd-collectioneditor-action" data-bind="dxButton: { onClick: remove, disabled: selectedIndex() === null, text: $parent.removeButtonTitle }, attr: { title: $parent.removeButtonTitle }"></div>
            </div>
        </div>
    </div>
</script>
...
<script type="text/html" id="dx-wizard-menu-box-editorswitch">
    <div class="dxrd-editormenu-box dxd-property-grid-menu-box-color dxd-back-highlighted" data-bind="css: { 'dxd-state-active': $data.isExpression() }, dxButtonWithTemplate: { onClick: switchEditors, icon: 'dxrd-svg-wizard-expressions' }">
    </div>
</script>
<script type="text/html" id="dx-wizard-headerNew">
...
<script type="text/html" id="dx-wizard-newlayout">
    <div class="dxrd-wizard dx-editors dxd-text-primary" data-bind="dxPopup: {
        ...
        <div class="dxrd-wizard-content">
            <!-- ko with: _currentPage -->
            <div style="height: 100%" data-bind="template: { name: template, data: page } "></div>
            <!-- /ko -->
...
<script type="text/html" id="item-with-title">
...
<script type="text/html" id="dx-combobox-editable">
    <div data-bind="dxSelectBox: getOptions({ items: values, value: value, valueExpr: 'value', displayExpr: 'displayValue', disabled: disabled, placeholder: $root.dx.Analytics.Internal.selectPlaceholder(), acceptCustomValue: true, onCustomItemCreating: function(arg) { return { value: arg.text, displayValue: arg.text }; }, dropDownOptions: { container: $root.getPopupContainer($element) } })"></div>
</script>
...
<script type="text/html" id="dx-text">
    ...
    <div data-bind="dxTextBox: getOptions({ value: value, disabled: disabled }), dxValidator: getValidatorOptions($data.validatorOptions || { validationRules: validationRules || [] })"></div>
    <!-- /ko -->
    <!-- ko if: !$data.validationRules -->
    <div data-bind="dxTextBox: getOptions({ value: value, disabled: disabled })"></div>
    <!-- /ko -->
</script>
...
<script type="text/html" id="dx-collectioneditor">
    <div class="dx-collectioneditor">
        <div data-bind="dxdAccordion: { collapsed: collapsed, alwaysShow: alwaysShow }">
                ...
                <div class="dx-editor-header">
                    <div class="dx-field">
                        ...
                        <div class="dx-collectioneditor-actions-wrapper">
                            ...
                            <div class="dx-collectioneditor-action" data-bind="dxButtonWithTemplate: { onClick: remove, disabled: isDisabledButton('delete'), icon: 'dxrd-svg-operations-remove', iconClass: 'dx-image-remove' }, attr: { title: getDisplayTextButton('delete') }"></div>
                            <!-- /ko -->
                            <!-- ko if: isVisibleButton('add') -->
                            <div class="dx-collectioneditor-action" data-bind="dxButtonWithTemplate: { onClick: add, disabled: isDisabledButton('add'), icon: 'dxrd-svg-operations-add', iconClass: 'dx-image-add' }, attr: { title: getDisplayTextButton('add') }"></div>
                            <!-- /ko -->
                            <div class="dx-collectioneditor-action-separator"></div>
                            <!-- ko if: isVisibleButton('down') -->
                            <div class="dx-collectioneditor-action" data-bind="dxButtonWithTemplate: { onClick: down, disabled: isDisabledButton('down'), icon: 'dxrd-svg-operations-movedown', iconClass: 'dx-image-movedown' }, attr: { title: getDisplayTextButton('down') }"></div>
                            <!-- /ko -->
                            <!-- ko if: isVisibleButton('up') -->
                            <div class="dx-collectioneditor-action" data-bind="dxButtonWithTemplate: { onClick: up, disabled: isDisabledButton('up'), icon: 'dxrd-svg-operations-moveup', iconClass: 'dx-image-moveup' }, attr: { title: getDisplayTextButton('up') }"></div>
                            <!-- /ko -->
                        </div>
                        <!-- /ko -->
                        <!-- ko if: displayName -->
            ...
            <div class="dx-accordion-content">
                <div data-bind="dxScrollView: { showScrollbar: 'onHover', disabled: !showScroll, useNative: false, scrollByThumb: true }">
                    <!-- ko if: !disabled()-->
                    ...
                    <div class="dx-collectioneditor-items" data-bind="foreach: values">
                        <div data-bind="with: $parent.createCollectionItemWrapper($parents[1], $index, $element)">
                            <div class="dx-collectioneditor-item-container dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="dxclick: $parents[1].select, css: { 'dxd-state-selected' : $parents[1].selectedIndex() === $index() }">
                                <div class="dx-collection-item"></div>
                            </div>
                        </div>
                    </div>
...
<script type="text/html" id="dx-expressioneditor-description">
    <div class="dx-expressioneditor-tools-tab-content-wrapper dxd-border-secondary " data-bind="dxScrollView: { showScrollbar: 'onHover' }">
        <div class="dx-expressioneditor-description dxd-text-primary" data-bind="text: content"></div>
    </div>
</script>
...
<script type="text/html" id="dx-filtereditor-content-text">
    ...
    <!-- /ko -->
    <!-- ko if: aceAvailable -->
    <div class="dx-filtereditor-text dx-texteditor dx-textarea dx-editor-outlined" data-bind="css: {'dx-invalid': !$data.isValid(), 'dx-state-focused': textFocused }">
...
<script type="text/html" id="dx-filtereditor">
    <div>
        <div class="no-margin-right" data-bind="dxEllipsisEditor: { value: modelDisplayValue, isValid: modelValueIsValid, disabled: disabled, buttonAction: function() { popupVisible(true); } }"></div>
...
<script id="dx-filtereditor-value" type="text/html">
    <div class="criteria-operator-item" data-bind="visible: isEditable">
        ...
        <div class="criteria-operator-item-editor" data-bind="focus: isEditable, dxLocalizedSelectBox: { dataSource: [ { val: 'True', text: 'Yes', localizationId: 'AnalyticsCoreStringId.ParametersPanel_True' }, { val: 'False', text: 'No', localizationId: 'AnalyticsCoreStringId.ParametersPanel_False' }], valueExpr: 'val', displayExpr: 'text', value: _value, onFocusOut: function() { isEditable(false); }, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
        <!-- /ko -->
        <!-- ko if: $data.specifics() === "date" -->
        <div class="criteria-operator-item-editor" data-bind="focus: isEditable, dxDateBox: { value: _value, closeOnValueChange: true, type: 'date', onFocusOut: function() { isEditable(false); }, dropDownOptions: { container: $root.getPopupContainer($element) } }"></div>
        <!-- /ko -->
        ...
        <div class="criteria-operator-item-editor" data-bind="focus: isEditable, dxSelectBox: { value: _value, dataSource: dataSource, valueExpr: 'value', displayExpr: 'display', searchEnabled: true, onFocusOut: function() { isEditable(false); }}, dropDownOptions: { container: $root.getPopupContainer($element) }"></div>
        <!-- /ko -->
        <!-- ko if: $data.items.length > 0 && typeof $data.items[0] !== "object" -->
        <div class="criteria-operator-item-editor" data-bind="focus: isEditable, dxSelectBox: { value: _value, dataSource: dataSource, acceptCustomValue: true, searchEnabled: true, onFocusOut: function() { isEditable(false); }, dropDownOptions: { container: $root.getPopupContainer($element) }}"></div>
        <!-- /ko -->
    </div>
    <div class="criteria-operator-text dxd-filter-editor-text-color criteria-operator-item-value dxd-filter-editor-value-back-color" data-bind="visible: !isEditable()">
...
<script type="text/html" id="dx-treelist-edit-action">
    <div class="dx-treelist-action-edit dx-accordion-button" data-bind="dxButtonWithTemplate: { icon: 'dxrd-svg-operations-edit', iconClass: 'dx-image-edit',  onClick: function() { $parent.collapsed(!$parent.collapsed()); } }, visible: $parent.hasContent, attr: { title: $data.displayText() }"></div>
</script>
...
<script type="text/html" id="dx-treelist-item-ellipsis">
    <div class="dx-treelist-item dxd-list-item-back-color dxd-back-highlighted" data-bind="styleunit: padding, click: renderNext">
        <div class="dx-treelist-collapsedbutton"></div>
        <div class="dx-treelist-caption">
            <div class="dx-treelist-selectedcontent">
                <div class="dx-treelist-text-wrapper">
                    <div class="dx-treelist-ellipsis-text dxd-text-accented dxd-hyperlink-color" data-bind="text: $data.text()"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="dx-treelist-header-item">
    <div class="dx-treelist-item dxd-list-item-back-color dxd-back-highlighted" data-bind="event: { dblclick: function() { $data.dblClickHandler ? $data.dblClickHandler($data) : $data.toggleCollapsed() } }, styleunit: padding, css: { 'dx-treelist-item-selected dxd-state-selected': isSelected() || isMultiSelected() }">
        ...
        <div class="dx-treelist-collapsedbutton" data-bind="css: nodeImageClass, template: 'dxrd-svg-collapsed', click: toggleCollapsed"></div>
        <!-- /ko -->
        <div class="dx-treelist-caption" data-bind="style: { 'padding-left': $data.hasItems ? '0px': '18px' }">
            <!-- ko if: actions && actions.length > 0 -->
            ...
            <!-- /ko  -->
            <!-- ko if: isDraggable -->
            <div class="dx-treelist-selectedcontent" data-bind="click: toggleSelected, draggable: dragDropHandler">
                <!-- ko template: { name: 'dx-treelist-header-item-caption-content' } -->
                <!-- /ko -->
            </div>
            <!-- /ko -->
            <!-- ko ifnot: isDraggable -->
            <div class="dx-treelist-selectedcontent" data-bind="click: toggleSelected">
                <!-- ko template: { name: 'dx-treelist-header-item-caption-content' } -->
                <!-- /ko -->
            </div>
...
<script type="text/html" id="dx-treelist-item-text-content">
    <div class="dx-treelist-text-wrapper">
        <!--ko if: treeListController.searchEnabled -->
        <div class="dx-treelist-text dx-highlighted-search-text" data-bind="searchHighlighting: { text: text, textToSearch: treeListController.textToSearch, searchOptions: treeListController.searchOptions }, attr: { title: text }"></div>
        <!-- /ko  -->
        <!--ko ifnot: treeListController.searchEnabled -->
...
<script type="text/html" id="dx-treelist-header-item-with-hover">
    <div class="dx-background-inheritor dxd-back-highlighted dxd-state-selected">
        <div class="dx-treelist-item dx-fontsize-reestablished dxd-list-item-back-color" data-bind="event: {
         ...
         mouseenter: mouseenter,
         mouseleave: mouseleave
    }, styleunit: padding, css: { 'dx-treelist-item-selected dxd-state-selected dxd-back-secondary': isSelected() || isMultiSelected() }">
...
<script type="text/html" id="dx-treelist">
    <div class="dx-treelist dxd-text-primary">
        <!-- ko template: $data.visibleItems !== undefined ? 'dx-treelist-paginate' : 'dx-treelist-common' -->
        <!-- /ko -->
    </div>
</script>

<script type="text/html" id="dx-treelist-search-panel">
    <div class="dxrd-treelist-search-panel" data-bind="dxTextBox: { mode: 'search',  value:value, activeStateEnabled:false, focusStateEnabled:false, hoverStateEnabled:false, valueChangeEvent: 'keyup', showClearButton: true, placeholder: searchPlaceholder()}"></div>
</script>

<script type="text/html" id="dx-treelist-common">
    <!-- ko foreach: items -->
    <!-- ko lazy: { resolver: resolver, innerBindings: { template: templateName } } -->
    <!-- /ko -->
    <!-- ko if: !$data.collapsed() -->
...
<script type="text/html" id="dx-treelist-paginate">
...
<script type="text/html" id="dxrd-colorpicker">
    <div data-bind="dxColorBox: { value: displayValue, editAlphaChannel: true, disabled: disabled, dropDownOptions: { container: $root.getPopupContainer($element), position: { at: 'left bottom', collision: 'flipfit flipfit', my: 'left top', boundary: $root.getPopupContainer($element), of: $element } } }"></div>
</script>
...
<script type="text/html" id="dxrd-designer">
    <div data-bind="css: surfaceClass($element)">
...
<script type="text/javascript" id="dx-propertygrid-searchbox">
...
<script type="text/html" id="dx-right-panel-lightweight">
    <div class="dxrd-right-panel dx-shadow dxd-border-secondary dxd-property-grid-group-header-back-color dxd-back-primary2" data-bind="styleunit: { width: tabPanel.width }, css: tabPanel.cssClasses(), resizable: tabPanel.getResizableOptions($element, '1px', 325)">
...
<script type="text/html" id="dxrd-right-panel-template-base">
    <div class="dx-shadow dxd-border-secondary dxrd-tab-panel-wrapper" data-bind="styleunit: { width: tabPanel.headerWidth }, css: tabPanel.cssClasses({'dxrd-tab-panel-border': !tabPanel.collapsed()})">
        <div class="dxrd-right-panel-collapse dxd-back-primary dxd-button-back-color dxd-state-normal dxd-back-highlighted" data-bind="styleunit: { width: tabPanel.headerWidth }, css: tabPanel.cssClasses(), dxclick: function() { tabPanel.collapsed(!tabPanel.collapsed()); }, attr: { title: tabPanel.toggleCollapsedText }">
            <div class="dxrd-right-panel-collapse-image" data-bind="css: tabPanel.toggleCollapsedImage().class, template: tabPanel.toggleCollapsedImage().template"></div>
        </div>

        <div class="dxrd-right-panel dxd-property-grid-group-header-back-color dxd-back-primary2" data-bind="styleunit: { width: tabPanel.width }, css: tabPanel.cssClasses(), resizable: tabPanel.getResizableOptions($element, '50px', 340)">
            <!-- ko foreach: tabPanel.tabs -->
            <!-- ko lazy: { template: $data.template } -->
            <!-- /ko -->
            <!-- /ko -->
        </div>
        <div class="dxrd-right-tabs dxd-side-panel-tabs-back-color dxd-back-contrast" data-bind="css: tabPanel.cssClasses()">
            <!-- ko foreach: tabPanel.tabs -->
            <div class="dxrd-tab-item dxd-side-panel-tab-back-color dxd-back-highlighted" data-bind="dxclick: function(s) { $parent.tabPanel.selectTab({ model: s }) }, css: { 'dxd-state-active dxd-state-no-hover': active, 'dxrd-tab-item-disabled': disabled }, attr: { title: text }, visible: visible">
