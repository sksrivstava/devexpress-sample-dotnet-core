/**
* DevExpress HTML/JS Analytics Core (dx-analytics.darkmoon.compact.css)
* Version: 20.1.6
...
.dx-designer-viewport .dxd-scrollbar-color {
  scrollbar-face-color: #4e607f;
  scrollbar-track-color: #8e9cb1;
  scrollbar-arrow-color: #afbbcd;
  -ms-scrollbar-face-color: #4e607f;
  -ms-scrollbar-track-color: #8e9cb1;
  -ms-scrollbar-arrow-color: #afbbcd;
}
