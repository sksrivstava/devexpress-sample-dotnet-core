/**
* DevExpress HTML/JS Analytics Core (dx-analytics.carmine.compact.css)
* Version: 20.1.6
...
.dx-designer-viewport .dxd-scrollbar-color {
  ...
  scrollbar-track-color: #a7afb4;
  scrollbar-arrow-color: #80868a;
  -ms-scrollbar-face-color: #f5f5f5;
  -ms-scrollbar-track-color: #a7afb4;
  -ms-scrollbar-arrow-color: #80868a;
}
