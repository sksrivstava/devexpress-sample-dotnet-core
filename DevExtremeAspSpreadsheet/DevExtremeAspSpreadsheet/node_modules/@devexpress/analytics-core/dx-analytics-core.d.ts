...
declare module DevExpress.Analytics {
    ...
    module Widgets {
        ...
        class Editor extends Utils.Disposable {
            ...
            rtl: boolean;
            protected _accessibilityProvider: ko.Observable<Analytics.Internal.IPropertiesAccessibilityProvider>;
            private _validator;
            dispose(): void;
            ...
            registerAccessibilityProvider(accessibilityProvider: Analytics.Internal.IPropertiesAccessibilityProvider): void;
        ...
        class ObjectProperties extends Utils.Disposable {
            ...
            protected _accessibilityProvider: Analytics.Internal.IPropertiesAccessibilityProvider;
            ...
            protected _update(viewModel: Analytics.Internal.IControlPropertiesViewModel, editorsInfo: any, recreateEditors: any): void;
    ...
    module Internal {
        interface IPropertiesAccessibilityProvider {
            isPropertyVisible(editor: Widgets.Editor): any;
            isPropertyDisabled(editor: Widgets.Editor): any;
        }
        class PropertiesAccessibilityProvider implements IPropertiesAccessibilityProvider {
            isPropertyVisible(editor: Widgets.Editor): boolean;
            isPropertyDisabled(editor: Widgets.Editor): any;
            private _calculateAccessibilityByPropertyInfo;
        }
        var defaultAccessibilityProvider: PropertiesAccessibilityProvider;
        class PopupService {
...
declare module DevExpress.Analytics {
    ...
    module Internal {
        function integerValueConverter(val: any, defaultValue: any, type?: any): any;
        ...
        function floatValueConverter(val: any, defaultValue: any, type?: any): any;
...
declare module DevExpress.Analytics {
    ...
    module Internal {
        ...
        class CommonDesignerGenerator<T extends IDesignerModel> extends Utils.Disposable {
            ...
            addControlProperties(editors: any, groups: GroupObject, groupLocalizationIDs: any, accessibilityProvider?: Analytics.Internal.IPropertiesAccessibilityProvider): this;
            addPopularProperties(controlsFactory: any, accessibilityProvider?: Analytics.Internal.IPropertiesAccessibilityProvider): this;
